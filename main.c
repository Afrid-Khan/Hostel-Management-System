...
printf("| |  | |         | |     | | |  \/  |                                                 | |  \n");
printf("| |__| | ___  ___| |_ ___| | | \  / | __ _ _ __   __ _  __ _  ___ _ __ ___   ___ _ __ | |_ \n");
printf("|  __  |/ _ \/ __| __/ _ \ | | |\/| |/ _` | '_ \ / _` |/ _` |/ _ \ '_ ` _ \ / _ \ '_ \| __|\n");
printf("| |  | | (_) \__ \ ||  __/ | | |  | | (_| | | | | (_| | (_| |  __/ | | | | |  __/ | | | |_ \n");
printf("|_|  |_|\___/|___/\__\___|_| |_|  |_|\__,_|_| |_|\__,_|\__, |\___|_| |_| |_|\___|_| |_|\__|\n");
printf("                                                        __/ |\n");
printf("                                                       |___/\n");
...
void saveInformationToFile()
{
    ...
    for(int i=0; i<customerCount; i++)
    {
        ...
        fprintf(customerfile,"%s %d %d\n",customerArray[i].name,customerArray[i].contactNumber,customerArray[i].roomID);
    }
    fclose(roomFIle);
    fclose(customerfile);
